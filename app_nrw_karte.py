...
st.markdown("""
    ...
    /* Container für die Karte, damit das absolute Overlay exakt darauf ausgerichtet ist */
    .map-container {
        position: relative;
        width: 100%;
    }
    /* Schwebendes Overlay oben rechts direkt in der Karte */
...
# Live-Übersicht als schwebendes Overlay Oben Rechts über der Karte
active_filters = []
if selected_units:
