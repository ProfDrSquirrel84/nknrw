...
# ==============================================================================
# Custom CSS für Vollbildkarte & schwebende Overlays (oben & unten rechts)
# ==============================================================================
st.markdown("""
    <style>
    .block-container {
    ...
    /* Schwebendes Overlay unten rechts (Diagramm über der Karte) */
...
# ==============================================================================
# 8. Vollflächige Karte mit schwebenden Overlays (Oben & Unten Rechts)
# ==============================================================================
...
# 1. Overlay Oben Rechts (Live-Übersicht / KPIs)
active_filters = []
if selected_units:
...
st.markdown(f"""
    <div class="floating-overlay-top">
...
# 2. Overlay Unten Rechts (Diagramm über der Karte)
series_split = (
...
if not series_split.empty:
    ...
    # Rendering des Diagramms in einem Streamlit-Container platziert als unteres Overlay
    st.markdown('<div class="floating-overlay-bottom">', unsafe_allow_html=True)
...
# ==============================================================================
# 9. Factsheet bei Klick auf ein Polygon (unter der Vollbildkarte)
# ==============================================================================
